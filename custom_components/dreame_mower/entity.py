...
class DreameMowerEntityDescription:
    ...
    exists_fn: Callable[[object, object], bool] = lambda description, device: bool(
        ...
        or (
            isinstance(description.property_key, DreameMowerAutoSwitchProperty)
...
class DreameMowerEntity(CoordinatorEntity[DreameMowerDataUpdateCoordinator]):
    ...
    def __init__(
        ...
        description: DreameMowerEntityDescription = None,
    ) -> None:
    ...
    async def _try_command(self, mask_error, func, *args, **kwargs) -> bool:
        """Call a mower command handling error messages."""
    ...
    def device_info(self) -> DeviceInfo:
        """Return device information about this Dreame Mower device."""
        if self.device.info:
            return DeviceInfo(
